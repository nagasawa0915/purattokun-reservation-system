...
window.SpineUIManager = SpineUIManager;
window.generateCharacterSelectionButtons = generateCharacterSelectionButtons;
window.setupCharacterSelectionListeners = setupCharacterSelectionListeners;
window.createEditStartUI = createEditStartUI;
window.createEditingUI = createEditingUI;
window.setupEditingUIEvents = setupEditingUIEvents;
window.removeEditStartUI = removeEditStartUI;
window.removeEditingUI = removeEditingUI;
window.startCoordinateDisplay = startCoordinateDisplay;
window.createDraggableTitleBarModule = createDraggableTitleBarModule;

console.log('✅ Spine UI Manager モジュール - マイクロモジュール化完了');