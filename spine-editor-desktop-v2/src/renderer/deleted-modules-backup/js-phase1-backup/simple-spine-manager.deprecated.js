/**
 * 🗃️ DEPRECATED - Simple Spine Manager v2.0
 * 2025-08-18: 責務をpreview-manager.js、spine-preview-layer.jsに統合済み
 * 
 * このファイルは廃止されました。代わりに以下を使用してください：
 * - preview-manager.js: Spineフォルダ選択、キャラクター検出
 * - spine-preview-layer.js: WebGL描画、アニメーション管理
 * 
